...
class Config:
    ...
    WEBHOOK_SECRET = os.environ.get('WEBHOOK_SECRET', 'd69d5c5f0748cee7e7bf51eaccb51502')
    BASE_URL = os.environ.get('BASE_URL', 'https://plankton-app-9im8u.ondigitalocean.app/webhook/order_status')   
