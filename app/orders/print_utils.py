...
from app.utils import get_user_from_cookies, process_order_data, format_date, create_session
...
def get_quick_list_data():
    ...
    orders_data = fetch_orders_parallel(order_ids, access_token, max_workers=min(10, len(order_ids)))
