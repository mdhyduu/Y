from flask import request, redirect, url_for, flash, make_response, render_template, jsonify
import requests
...
DEFAULT_WORKERS = 3  # قلل العدد حسب موارد السيرفر
...
def get_quick_list_data():
    ...
    orders_data = fetch_orders_parallel(order_ids, access_token, max_workers=min(3, len(order_ids)))
